...
class Chat:
    ...
    def janela(self):
        ...
        self.caixa_texto.place(relx=0.05, rely=0.01, width=700, heigth=600)
        self.envia_mensagem = Entry(self.root)
        self.envia_mensagem.place(relx=0.05, rely=0.08, width=500, heigth=20)

        self.btn_enviar = Button(self.root, text='Enviar', command=self.enviarMensagem)
        self.btn_enviar.place(relx=0.7, rely=0.8, width=100, heigth=20)
        self.root.proticil("WM_DELETE_WINDOW", self.fechar)
